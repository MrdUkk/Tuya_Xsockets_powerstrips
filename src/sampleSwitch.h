...
extern const zcl_specClusterInfo_t g_sampleSwitchClusterList[5][5];
extern const af_simple_descriptor_t App_simpleDesc[5];

/* Attributes */
extern zcl_basicAttr_t g_zcl_basicAttrs;
extern zcl_identifyAttr_t g_zcl_identifyAttrs;
extern zcl_onOffAttr_t g_zcl_onOffAttrs[5];
