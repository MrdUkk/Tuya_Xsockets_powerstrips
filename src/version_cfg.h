...
#define IMAGE_TYPE_5SOCKETSTRIP1       (0x01 | (IMAGE_TYPE_BOOT_FLAG << 7))
...
#define ZCL_BASIC_DATE_CODE    {8,'2','0','2','5','1','0','1','6'}
#endif


//without this define telink SDK will screwup internally
 ...
 */
#define MANUFACTURER_CODE               0xBEEF
#define	IMAGE_TYPE                      ((CHIP_TYPE << 8) | IMAGE_TYPE_5SOCKETSTRIP1)
